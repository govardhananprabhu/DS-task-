"""
Question
Construct the level order tree from the list and find the right diagonal values
of tree.
...
Hint:
Traverse through the right side nodes only,print all the traversed nodes.
solution:"""
class newNode: 
